...
const WritingResultDetail: React.FC<WritingResultDetailProps> = ({
    ...
    return (
        <Col xs={24}>
                ...
                <p className="text-red-600 font-normal italic">*Đây là đề Ielts writing bạn có sử dụng tính năng chấm điểm với AI</p>
                    ...
                    <Col key={session.sessionId} xs={24}>
                        ...
                        {session.incorrectAnswers.map((answer: any) => (
                            ...
                            >
                                ...
                                {loading && <div className='mt-2'><Skeleton active/></div>}
                                {result && (
                                    <div
