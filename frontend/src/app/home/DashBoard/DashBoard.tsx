...
const Dashboard = () => {
    ...
    return (
        ...
        <div className="container mx-auto px-4 py-10">
            ...
            {userCourse ? (
                <>
                    <h2 className="text-xl font-semibold text-[#35509a] mb-2">
                        KHÓA HỌC ĐÃ MUA
                    </h2>
                        ...
                        {userCourse?.length > 0 &&
                            userCourse.map((item) => (
                                item?.paymentStatus === 'COMPLETED' && (
                                    ...
                                    >
                                        <Link href={`learning/${item.course._id}`}>
                                            <div className="p-6">
                    ...
                    <Link href="courses-online" className="text-blue-500 mt-2 inline-block">
                        Xem tất cả &gt;&gt;
                    </Link>
                </>
            ) : (
                            ...
                            {listCourse?.length > 0 &&
                                listCourse?.map((item) => (
                                    <div
                                        ...
                                        className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                                    >
                                        <Link href={`detailonlinecourse/${item._id}`}>
                                            <div className="p-6">
                                                <div className="flex justify-between items-start mb-4">
                                                    <h3 className="font-semibold text-gray-900">
                                                        {item.title}
